...
import { Bulb, ClientesSvg, DivisasSvg } from './Svg.jsx'
                ...
                <div className='max-w-[1140px] mx-auto px-3 '>
                    <div className='grid lg:grid-cols-2 pt-1 sm:pt-[100px] gap-3 sm:gap-12'>
                        ...
                        <div className=' flex items-center flex-col lg:items-start justify-center'>
                            ...
                            <div className='flex mt-3 sm:mt-[30px] justify-center items-center sm:w-[374px] w-[300px] gap-4 sm:gap-[37px] px-[10px] py-4 sm:px-[24px] sm:py-[24px] bg-transparent border border-[#39825F] border-solid rounded-[50px]'>
                            ...
                            <div className='flex mt-4 sm:mt-[24px] mb-4 md:mb-[24px] justify-center items-center sm:w-[374px] w-[300px] gap-4 sm:gap-[37px] px-[10px] py-4 sm:px-[24px] sm:py-[24px] bg-transparent border border-[#39825F] border-solid rounded-[50px]'>
                                <span className='flex justify-center items-center bg-[#0F2F28] h-[68px] w-[68px] rounded-[73px]'>
                                    <ClientesSvg />
                                </span>
                            ...
                            <div className='flex justify-center items-center sm:w-[374px] w-[300px] gap-4 sm:gap-[37px] px-[10px] py-4 sm:px-[24px] sm:py-[24px] bg-transparent border border-[#39825F] border-solid rounded-[50px]'>
                                <span className='flex justify-center items-center bg-[#0F2F28] h-[68px] w-[68px] rounded-[73px]'>
                                    <DivisasSvg />
                                </span>
